...
exports.StockBulkRepository = void 0;
...
let StockBulkRepository = class StockBulkRepository extends database_mongo_bulk_repository_abstract_1.DatabaseMongoBulkRepositoryAbstract {
    constructor(stockModel) {
        super(stockModel);
        this.stockModel = stockModel;
    }
};
StockBulkRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, database_decorator_1.DatabaseEntity)(stock_schema_1.StockEntity.name)),
    __metadata("design:paramtypes", [mongoose_1.Model])
], StockBulkRepository);
exports.StockBulkRepository = StockBulkRepository;
//# sourceMappingURL=stock.bulk.repository.js.map
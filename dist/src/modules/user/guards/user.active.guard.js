...
exports.UserActiveGuard = void 0;
...
let UserActiveGuard = class UserActiveGuard {
    ...
    async canActivate(context) {
        const required = this.reflector.getAllAndOverride(user_constant_1.USER_ACTIVE_META_KEY, [context.getHandler(), context.getClass()]);
        if (!required) {
            return true;
        }
        ...
        if (!required.includes(__user.isActive)) {
            throw new common_1.BadRequestException({
                statusCode: user_status_code_constant_1.ENUM_USER_STATUS_CODE_ERROR.USER_ACTIVE_ERROR,
...
exports.UserActiveGuard = UserActiveGuard;

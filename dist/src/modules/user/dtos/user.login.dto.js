...
class UserLoginDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { email: { required: true, type: () => String, maxLength: 100 }, rememberMe: { required: false, type: () => Boolean }, password: { required: true, type: () => String } };
    }
}
__decorate([
...
__decorate([
    ...
    (0, class_validator_1.ValidateIf)((e) => e.rememberMe !== ''),

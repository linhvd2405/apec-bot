...
export interface IUserService {
    ...
    create(data: IUserCreate, options?: IDatabaseCreateOptions): Promise<UserDocument>;
    ...
    updatePassword(_id: string, data: IAuthPassword, options?: IDatabaseOptions): Promise<UserDocument>;

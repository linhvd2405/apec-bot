...
let RoleUsedGuard = class RoleUsedGuard {
    ...
    async canActivate(context) {
        ...
        const check = await this.userService.findOne({
            role: new mongoose_1.Types.ObjectId(__role._id),
        });
        if (check) {
...
RoleUsedGuard = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [user_service_1.UserService])
], RoleUsedGuard);
exports.RoleUsedGuard = RoleUsedGuard;
//# sourceMappingURL=role.used.guard.js.map
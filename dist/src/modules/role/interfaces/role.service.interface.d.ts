...
export interface IRoleService {
    ...
    create(data: RoleCreateDto, options?: IDatabaseCreateOptions): Promise<RoleDocument>;
    createSuperAdmin(options?: IDatabaseOptions): Promise<RoleDocument>;
    update(_id: string, data: RoleUpdateDto, options?: IDatabaseOptions): Promise<RoleDocument>;

...
const response_timeout_interceptor_1 = require("./interceptors/response.timeout.interceptor");
        ...
        providers: [
            {
                ...
                useClass: response_timeout_interceptor_1.ResponseTimeoutInterceptor,
            },
            {
                provide: core_1.APP_INTERCEPTOR,

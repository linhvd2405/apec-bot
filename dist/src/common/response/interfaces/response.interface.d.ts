...
export interface IResponseDocPagingOptions extends Omit<IResponseDocOptions, 'httpStatus'> {
...
export interface IResponsePagingOptions<T> extends Omit<IResponseOptions<T>, 'excludeRequestBodyJson' | 'doc'> {
    doc?: IResponseDocPagingOptions;
}
export declare type IResponseExcelOptions<T> = IResponseOptions<T>;
export declare type IResponseExcel = IHelperFileExcelRows[];

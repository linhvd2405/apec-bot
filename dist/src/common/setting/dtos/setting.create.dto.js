...
const request_string_or_number_or_boolean_validation_1 = require("../../request/validations/request.string-or-number-or-boolean.validation");
class SettingCreateDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String }, description: { required: false, type: () => String }, value: { required: true, type: () => Object } };
    }
}
__decorate([
...
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    (0, request_string_or_number_or_boolean_validation_1.StringOrNumberOrBoolean)(),
    (0, swagger_1.ApiProperty)({
        name: 'value',

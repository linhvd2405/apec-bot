...
export interface ISettingService {
    ...
    create(data: SettingCreateDto, options?: IDatabaseCreateOptions): Promise<SettingDocument>;
    updateOneById(_id: string, data: SettingUpdateDto, options?: IDatabaseOptions): Promise<SettingDocument>;

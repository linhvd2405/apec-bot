...
let JwtStrategy = class JwtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, 'jwt') {
    ...
    async validate({ data, }) {
        return this.configService.get('app.env') === 'production'
            ? this.helperEncryptionService.aes256Decrypt(data, this.configService.get('auth.jwt.accessToken.encryptKey'), this.configService.get('auth.jwt.accessToken.encryptIv'))
            : data;
    }
};

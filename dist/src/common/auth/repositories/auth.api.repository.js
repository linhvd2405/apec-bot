...
let AuthApiRepository = class AuthApiRepository extends database_mongo_repository_abstract_1.DatabaseMongoRepositoryAbstract {
    constructor(authApiModel) {
        super(authApiModel);
        this.authApiModel = authApiModel;
    }
};
AuthApiRepository = __decorate([

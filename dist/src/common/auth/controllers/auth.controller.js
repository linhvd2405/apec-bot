...
const auth_info_serialization_1 = require("../serializations/auth.info.serialization");
...
__decorate([
    (0, response_decorator_1.Response)('auth.info', { classSerialization: auth_info_serialization_1.AuthInfoSerialization }),

...
export interface IAuthApiService {
    ...
    create(data: AuthApiCreateDto, options?: IDatabaseCreateOptions): Promise<IAuthApi>;
    createRaw(data: AuthApiCreateRawDto, options?: IDatabaseCreateOptions): Promise<IAuthApi>;

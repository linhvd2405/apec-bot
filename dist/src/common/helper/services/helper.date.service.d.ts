...
import { IHelperDateOptionsBackward, IHelperDateOptionsCreate, IHelperDateOptionsDiff, IHelperDateOptionsFormat, IHelperDateOptionsForward, IHelperDateOptionsMonth } from 'src/common/helper/interfaces/helper.interface';
export declare class HelperDateService implements IHelperDateService {
